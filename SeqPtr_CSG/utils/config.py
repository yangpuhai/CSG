...
parser = argparse.ArgumentParser(description='SeqPtr Multi-Domain DST')

# Training Setting
parser.add_argument('-mode','--mode', help='mode', required=False, default="enc")
...
parser.add_argument('-all_vocab','--all_vocab', help='', required=False, default=0, type=int)
...
parser.add_argument('-bsz','--batch', help='Batch_size', default=32, required=False, type=int)
...
parser.add_argument('-dec','--decoder', help='decoder model', required=False,default='SeqPtr')
...
parser.add_argument('-onlyd','--only_domain', help='', required=False, default="restaurant", type=str)
