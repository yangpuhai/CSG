...
class SeqPtr(nn.Module):
    ...
    def save_model(self, dec_type):
        directory = 'save/SeqPtr-' + args["addName"] + args['dataset'] + str(self.task) + '-' + str(
    ...
    def forward(self, batch_size, encoded_hidden, encoded_outputs, encoded_lens, story, max_res_len, target_batches, use_teacher_forcing, slot_temp, data_plain):
        ...
        for slot in slot_temp:
            ...
            for wi in range(max_res_len):
                ...
                words.append([data_plain[w_idx][pred_word[w_idx].item()] for w_idx in range(pred_word.size(0))])
